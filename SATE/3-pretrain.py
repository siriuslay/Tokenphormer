...
from SATE_utils.file_utils import  WEIGHTS_NAME, CONFIG_NAME
from SATE_utils.modeling import BertForMaskedLM, BertConfig
from SATE_utils.tokenization import BertTokenizer
from SATE_utils.optimization import BertAdam
    ...
    if args.do_train:
        ...
        for e in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            for step, batch in enumerate(tqdm(train_dataloader, desc="Iteration")):
                ...
                #     CheckInfo = "epoch" + str(e) + "_step" + str(nb_tr_steps) + ".pth"
                #     checkpoint = {'state_dict': model.state_dict(), 'optimizer': optimizer.state_dict()}
                #     checkpoint_path = args.output_dir + "checkpoints/"
                #     if not os.path.exists(checkpoint_path):
                #         os.makedirs(checkpoint_path)
                #     checkpoint_file = os.path.join(checkpoint_path, CheckInfo)
            ...
            # f nb_tr_steps > 0 and nb_tr_steps % 2000 == 0:
            if nb_tr_steps > 0:
