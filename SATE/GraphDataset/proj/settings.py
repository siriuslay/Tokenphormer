...
class ServerInfo:
    def __init__(self, gpu_mem=12, n_gpus=4):
        self.gpu_mem = gpu_mem
        self.n_gpus = n_gpus

    def __str__(self):
        return f'SERVER INFO: {self.gpu_mem}Gx{self.n_gpus}'

SV_INFO = ServerInfo(gpu_mem=24, n_gpus=1)
...
DATA_PATH = f'./GraphDataset/go_data/'
